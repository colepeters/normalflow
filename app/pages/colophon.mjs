export default function Colophon({ html }) {
  return html`
    ...
    <p>The name ‘Normal Flow’ refers to <a href='https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flow_Layout'>the algorithm</a> used to display HTML elements on a web page before any styling changes are made.</p>
    <p>This website is typeset in Signifier by <a href='https://klim.co.nz/'>Klim Type Foundry</a>.</p>
  `
}
